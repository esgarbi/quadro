...
smallest possible demonstration of ``stage(workflow=...)``. Sagas
would also work, but the value of this file is being short — every
line earns its keep, and adding a saga would add lines without
